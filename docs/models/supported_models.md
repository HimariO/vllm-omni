...
| `OmniSenseNovaVisionForConditionalGeneration` | SenseNova-Vision-7B-MoT | `sensenova/SenseNova-Vision-7B-MoT` | ✅︎ | | | | [Repository](https://github.com/vllm-project/vllm-omni/blob/main/recipes/SenseNova/SenseNovaVision.md) |
